...
insert into video_comment(id, video_id, user_id, date_posted, likes, comment, active)
values (2, 1, 2, now(), 133,
        'For a celebrity makeup line the prices are so affordable.. otherwise you can see kylie, kim and other big youtubers who launch their makeup line and their prices are sky-high',
        false);

insert into video_comment(id, video_id, user_id, date_posted, likes, comment, active)
values (3, 1, 3, now(), 76,
        'Instead of collaborating with Nyka people should collaborate with sugar!! Sugar cosmetics are so much better and underrated for some reason.',
        true);

insert into video_comment(id, video_id, user_id, date_posted, likes, comment, active)
values (4, 1, 1, now(), 368, 'ALSO pls stop this behaviour, you can''t look this good ok, teach me makeup', true);
...
insert into video_comment(id, video_id, user_id, date_posted, likes, comment, active)
values (7, 2, 1, now(), 10, 'Mam daily makeup karte h to kya or kaise skin ko clean n hydrate rakhe, acne prone skin',
        true);
...
insert into video_comment(id, video_id, user_id, date_posted, likes, comment, active)
values (9, 2, 1, now(), 10,
        'It looks fine on camera but we all know how in reality a lighter foundation makes us look. It definitely makes us grey or look whitish',
        true);
