...
public abstract class PostDtoArticleEntityMapper {
    ...
    public abstract ArticleEntity toEntity(PostDto postDto);
    ...
    public abstract PostDto toDto(ArticleEntity articleEntity);
}
