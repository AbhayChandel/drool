...
public class VideoRepositoryImplTest {
    ...
    public void test_findByIdActiveTrue() {
        assertNotNull(videoRepository.findByIdAndActiveTrue(activeVideoLikeUnlikeDto.getVideoId()));
    }

    @Test
    public void test_findByIdActiveFalse() {
        assertFalse(videoRepository.findByIdAndActiveTrue(ObjectId.get().toHexString()).isPresent());
    }

    @Test
    public void test_getLatestThreeByUser() {
        VideoThumbnailDataAggregation videoThumbnailDataAggregation = videoRepository.getLatestThreeVideosByUser("123");
    ...
    public void test_IncrementLikes() {
        ...
        assertEquals(1, videoRepository.findByIdAndActiveTrue(activeVideoLikeUnlikeDto.getVideoId()).get().getLikes());
    }
