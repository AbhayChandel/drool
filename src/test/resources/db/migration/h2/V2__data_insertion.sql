...
insert into discussion_topic(topic, user_id, date_posted, date_last_active, views, likes, replies) values ('Are Loreal lip colors better than Lakme or is it the other way around', 5, now(), now(), 15, 12, 1);
